...
- `src/Runner.tsx` — pixel dog and bone; sprites are string matrices compressed into paths
...
**Pixel art can't be rotated with a transform.** It comes out as blurred jaggies. The bone is drawn frame by frame instead: 0° and 45° by hand, the other two transposed from those. A bone is 180°-symmetric, so four frames read as a full turn.
